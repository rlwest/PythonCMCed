...
environment_memory = {
    'agent1hand': {'hand': 'open', 'move':'n'},
    'agent2hand': {'hand': 'open', 'move':'n'}
}

agent1_working_memory = {
    'focus_buffer': {'state': 'start'},
    'lag_buffer': {'lag1': 'rock', 'lag0': 'rock'}
}
...
ps.run_cycles(memories, AllProductionSystems, DelayResetValues, cycles=12, millisecpercycle=10)
